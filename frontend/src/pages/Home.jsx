...
const Home = () => {
  return (
    <div className="w-full h-full flex flex-col items-start justify-center">
      ...
      <div className="bg-mobileHero tb:bg-tabletHero dt:bg-desktopHero bg-fixed bg-no-repeat bg-cover bg-bottom w-screen h-screen flex items-center justify-center dt:justify-start">
